  ...
  return (
    <div
      ...
      <div className=" flex items-center justify-between p-5 md:p-9 text-black-900 dark:text-white-900">
        <button className="flex items-center justify-center w-auto h-12 text-2xl text-gray-900 dark:text-pink transition-transform duration-300 ease-in-out transform hover:scale-110">
